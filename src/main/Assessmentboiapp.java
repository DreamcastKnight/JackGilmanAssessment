	...
	public static void main(String[] args) {
		...
		while (!(p[0] == l[0]) | !(p[1] == l[1])) {
			...
			if (input.contains("north")) {
				...
				System.out.println("Rather than moving or doing anything, just stand in the same spot. Hopefully you can find the motivation to actually do something soon, this isn't very interesting at all to watch.");
			}
